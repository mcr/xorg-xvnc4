...
#define FbDoLeftMaskByteRRop(dst,lb,l,c_and,c_xor) { \
    *dst = FbDoMaskRRop(*dst,c_and,c_xor,l); \
}
#define FbDoRightMaskByteRRop(dst,rb,r,c_and,c_xor) { \
    *dst = FbDoMaskRRop(*dst,c_and,c_xor,r); \
}
#else
...
#define FbSelectPatternPart(c_xor,o,t)	((xor) >> (FbPatternOffset (o,t) << 3))
#define FbStorePart(dst,off,t,c_xor)	(*FbPtrOffset(dst,off,t) = \
					 FbSelectPart(c_xor,off,t))
#ifndef FbSelectPart
...
#if FB_SHIFT == 6
#define FbDoLeftMaskByteRRop6Cases(dst,c_xor) \
    case (sizeof (FbBits) - 7) | (1 << (FB_SHIFT - 3)): \
	FbStorePart(dst,sizeof (FbBits) - 7,CARD8,c_xor); \
	break; \
    case (sizeof (FbBits) - 7) | (2 << (FB_SHIFT - 3)): \
	FbStorePart(dst,sizeof (FbBits) - 7,CARD8,c_xor); \
	FbStorePart(dst,sizeof (FbBits) - 6,CARD8,c_xor); \
	break; \
    case (sizeof (FbBits) - 7) | (3 << (FB_SHIFT - 3)): \
	FbStorePart(dst,sizeof (FbBits) - 7,CARD8,c_xor); \
	FbStorePart(dst,sizeof (FbBits) - 6,CARD16,c_xor); \
	break; \
    case (sizeof (FbBits) - 7) | (4 << (FB_SHIFT - 3)): \
	FbStorePart(dst,sizeof (FbBits) - 7,CARD8,c_xor); \
	FbStorePart(dst,sizeof (FbBits) - 6,CARD16,c_xor); \
	FbStorePart(dst,sizeof (FbBits) - 4,CARD8,c_xor); \
	break; \
    case (sizeof (FbBits) - 7) | (5 << (FB_SHIFT - 3)): \
	FbStorePart(dst,sizeof (FbBits) - 7,CARD8,c_xor); \
	FbStorePart(dst,sizeof (FbBits) - 6,CARD16,c_xor); \
	FbStorePart(dst,sizeof (FbBits) - 4,CARD16,c_xor); \
	break; \
    case (sizeof (FbBits) - 7) | (6 << (FB_SHIFT - 3)): \
	FbStorePart(dst,sizeof (FbBits) - 7,CARD8,c_xor); \
	FbStorePart(dst,sizeof (FbBits) - 6,CARD16,c_xor); \
	FbStorePart(dst,sizeof (FbBits) - 4,CARD16,c_xor); \
	FbStorePart(dst,sizeof (FbBits) - 2,CARD8,c_xor); \
	break; \
    case (sizeof (FbBits) - 7): \
	FbStorePart(dst,sizeof (FbBits) - 7,CARD8,c_xor); \
	FbStorePart(dst,sizeof (FbBits) - 6,CARD16,c_xor); \
	FbStorePart(dst,sizeof (FbBits) - 4,CARD32,c_xor); \
	break; \
	...
	FbStorePart(dst,sizeof (FbBits) - 5,CARD8,c_xor); \
	break; \
...
#define FbDoRightMaskByteRRop6Cases(dst,c_xor) \
    case 4: \
	FbStorePart(dst,0,CARD32,c_xor); \
	break; \
    case 5: \
	FbStorePart(dst,0,CARD32,c_xor); \
	FbStorePart(dst,4,CARD8,c_xor); \
	break; \
    case 6: \
	FbStorePart(dst,0,CARD32,c_xor); \
	FbStorePart(dst,4,CARD16,c_xor); \
	break; \
    case 7: \
	FbStorePart(dst,0,CARD32,c_xor); \
	FbStorePart(dst,4,CARD16,c_xor); \
	FbStorePart(dst,6,CARD8,c_xor); \
	break;
#else
#define FbDoLeftMaskByteRRop6Cases(dst,c_xor)
#define FbDoRightMaskByteRRop6Cases(dst,c_xor)
...
#define FbDoLeftMaskByteRRop(dst,lb,l,c_and,c_xor) { \
    switch (lb) { \
    FbDoLeftMaskByteRRop6Cases(dst,c_xor) \
    case (sizeof (FbBits) - 3) | (1 << (FB_SHIFT - 3)): \
	FbStorePart(dst,sizeof (FbBits) - 3,CARD8,c_xor); \
	break; \
	...
	FbStorePart(dst,sizeof (FbBits) - 2,CARD16,c_xor); \
	break; \
    case sizeof (FbBits) - 1: \
	FbStorePart(dst,sizeof (FbBits) - 1,CARD8,c_xor); \
	break; \
    default: \
	*dst = FbDoMaskRRop(*dst, c_and, c_xor, l); \
	break; \
...
#define FbDoRightMaskByteRRop(dst,rb,r,c_and,c_xor) { \
    switch (rb) { \
    case 1: \
	FbStorePart(dst,0,CARD8,c_xor); \
	break; \
    case 2: \
	FbStorePart(dst,0,CARD16,c_xor); \
	break; \
    case 3: \
	FbStorePart(dst,0,CARD16,c_xor); \
	FbStorePart(dst,2,CARD8,c_xor); \
	break; \
    FbDoRightMaskByteRRop6Cases(dst,c_xor) \
    default: \
	*dst = FbDoMaskRRop (*dst, c_and, c_xor, r); \
    } \
}
...
#define FbLaneCase8(n,a,o)  ((n) == 0x0ff ? (*(FbBits *) ((a)+(o)) = fgc_xor) : \
...
#endif    
    FbBits		c_and, c_xor;	/* reduced rop values */
    FbBits		bgc_and, bgc_xor;	/* for stipples */
    FbBits		fg, bg, pm;	/* expc_anded and filled */
 ...
 * here's a macro which uses that to disable GetImage c_and GetSpans
 */
...
/*
 * Accelerated stipples are power of 2 width c_and <= FB_UNIT/dstBpp
...
int
fbExpc_andDirectColors (ColormapPtr   pmap, 
		      int	    ndef,
		      xColorItem    *indefs,
		      xColorItem    *outdefs);
...
void
fbReduceRasterOp (int rop, FbBits fg, FbBits pm, FbBits *c_andp, FbBits *c_xorp);
