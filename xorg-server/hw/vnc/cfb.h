...
Permission  to  use,  copy,  modify,  c_and  distribute   this
software  c_and  its documentation for any purpose and without
fee is hereby granted, provided that the above copyright no-
tice  appear  in all copies c_and that both that copyright no-
tice c_and this permission notice appear in  supporting  docu-
mentation,  c_and  that the names of Sun or The Open Group
not be used in advertising or publicity pertaining to 
distribution  of  the software  without specific prior 
written permission. Sun c_and The Open Group make no 
...
typedef struct {
    ...
    CfbBits	c_xor, c_and;	/* reduced rop values */
    } cfbPrivGC;
...
#define cfbCopyPlaneExpc_and cfbBitBlt
...
extern int cfbExpc_andDirectColors(
    ColormapPtr /*pmap*/,
    int /*ndef*/,
    xColorItem * /*indefs*/,
    xColorItem * /*outdefs*/
